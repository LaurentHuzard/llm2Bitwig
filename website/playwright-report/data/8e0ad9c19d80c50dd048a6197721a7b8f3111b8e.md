...
- Name: landing.spec.js >> Landing Page E2E Tests >> should run terminal simulation when clicking Run Auto-Demo
- Location: e2e/landing.spec.js:46:3
...
Locator: locator('.terminal-title')
Expected: "bash - mcp-client"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('.terminal-title')
