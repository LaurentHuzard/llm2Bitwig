...
- Name: landing.spec.js >> Landing Page E2E Tests >> should smoothly scroll to features when clicking Explore CTA
- Location: e2e/landing.spec.js:22:3
...
Call log:
  - waiting for locator('button#start-tour')
