...
type StepSequencerProps = {
    clipInfo: ClipInfo;
    notes?: NotesMap;
    onToggleNote: (step: number, pitch: number, velocity: number) => void;
};
...
export function StepSequencer({ clipInfo, notes = {}, onToggleNote }: StepSequencerProps) {
    ...
    const handleStepClick = (step: number, pitch: number) => {
...
function StepButton({ step, pitch, isPlaying, isActive, onClick }: StepButtonProps) {
