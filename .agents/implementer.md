...
## Responsibilities
- **Code Generation**: Writes typescript/javascript code, HTML, CSS, etc., to fulfill `docs/implementation_plan.md`.
...
## Instructions
1.  **Input**: Receives `docs/implementation_plan.md` and the current state of the codebase.
2.  **Execution**:
    -   Use the available coding/editing tools to apply changes.
