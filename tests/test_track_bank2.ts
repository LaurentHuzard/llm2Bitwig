...
async function main() {
    ...
    try {
        ...
        const bankText = bankStatus.content?.[0]?.text ?? "";
        console.log("Bank Status:", JSON.stringify(bankText, null, 2));
        ...
        const selectedText = selectedStatus.content?.[0]?.text ?? "";
        console.log("Selected Track Status:", JSON.stringify(selectedText, null, 2));
