...
async function run() {
    ...
    try {
        ...
        const status = await client.callTool<{ name?: string; isWindowOpen?: boolean }>("device_get_status");
        ...
        const status2 = await client.callTool<{ isWindowOpen?: boolean }>("device_get_status");
        ...
        const controls = await client.callTool<unknown[]>("device_get_remote_controls");
        ...
        await client.wait(100);
        await client.callTool<unknown[]>("device_get_remote_controls");
